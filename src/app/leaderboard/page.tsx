                ...
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center justify-between w-full md:w-auto">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-[10px] md:text-xs">查看各科尖子生，向优秀看齐。</p>
                            </div>
                        </div>
                    ...
                    <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row md:items-center gap-4 w-full md:w-auto pb-4 md:pb-0`}>
                        <div className="grid grid-cols-3 md:flex items-center gap-2 w-full md:w-auto">
                            <Link
                                href="/leaderboard"
                                className="flex items-center justify-center gap-2 bg-amber-50 dark:bg-amber-950/50 text-amber-600 dark:text-amber-400 px-3 py-2 rounded-xl text-xs font-bold border border-amber-100 dark:border-amber-900/50"
                            >
                            ...
                            <Link
                                ...
                                className="flex items-center justify-center gap-2 bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 px-3 py-2 rounded-xl text-xs font-bold hover:bg-rose-600 hover:text-white transition-all border border-rose-100 dark:border-rose-900/50"
                            >
...
{[...rankings].sort((a, b) => a.name.localeCompare(b.name, 'zh-Hans-CN')).map(r => (
                ...
                {loading ? (
                    ...
                    <div className="space-y-12">
                        {/* Podium Section - Only visible on desktop */}
                        <div className="hidden md:flex flex-row items-end justify-center gap-0 mt-8 mb-4 animate-in fade-in zoom-in duration-1000">
                            {/* 2nd place */}
                            {podium[1] && (
                                <div className={`w-1/3 flex flex-col items-center group transition-all duration-500 ${highlightStudentId === podium[1].id ? 'scale-105' : ''}`}>
                            ...
                            {/* 1st place */}
                            {podium[0] && (
                                <div className={`w-2/5 flex flex-col items-center z-10 group transition-all duration-500 ${highlightStudentId === podium[0].id ? 'scale-105' : ''}`}>
                            ...
                            {/* 3rd place */}
                            {podium[2] && (
                                <div className={`w-1/3 flex flex-col items-center group transition-all duration-500 ${highlightStudentId === podium[2].id ? 'scale-105' : ''}`}>
                                    <div className="relative mb-4">
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="bg-slate-50/50 dark:bg-slate-800/30 text-left text-[10px] font-black text-slate-400 uppercase tracking-[0.1em]">
                                            <th className="px-6 md:px-8 py-4">排名</th>
                                            <th className="px-6 md:px-8 py-4">姓名</th>
                                            <th className="hidden md:table-cell px-6 md:px-8 py-4">学号</th>
                                            <th className="hidden md:table-cell px-6 md:px-8 py-4 text-center">班级</th>
                                            <th className="px-6 md:px-8 py-4 text-right">分数</th>
                                            <th className="px-6 md:px-8 py-4 text-right">级排</th>
                                            <th className="hidden md:table-cell px-6 md:px-8 py-4 text-right">班排</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
                                        {rankings.map((student, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="hidden md:table-cell px-6 md:px-8 py-5">
                                                ...
                                                <td className="hidden md:table-cell px-6 md:px-8 py-5 text-center">
                                                ...
                                                <td className="hidden md:table-cell px-6 md:px-8 py-5 text-right">
